...
class TestTranslator(unittest.TestCase):
    def setUp(self):
        self.translator = Translator(name="Test Translator", description="A test translator", llm=None,
                                prompt_id="test_id", prompt_template="template", max_tokens=0)
    ...
    def test_parse_target_language(self):
        self.assertEqual(self.translator.parse_target_language("Translate this - [DE]"), "de")
        self.assertEqual(self.translator.parse_target_language("Translate this - [EN]"), "en-us")
        self.assertEqual(self.translator.parse_target_language("Translate this - [XX]"), "")

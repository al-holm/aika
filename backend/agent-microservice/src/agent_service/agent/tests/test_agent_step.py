...
from agent_service.agent.agent_step import AgentStep, AgentFinalStep, AgentValidationStep  

class TestAgentStep(unittest.TestCase):

    def test_initialization(self):
        step = AgentStep(thought="Thinking", action="Action", action_input="Input", observation="Observation")

...
![Introductory message](general/res/ui_examples/neue_lektion_1.png)\
*Introductory message*

![Grammar explanation for the lesson](general/res/ui_examples/neue_lektion_3.png)\
*Grammar explanation for the lesson 1*

![Grammar explanation for the lesson](general/res/ui_examples/neue_lektion_4.png)\
*Grammar explanation for the lesson 2*

![Gap-filling exercise](general/res/ui_examples/neue_lektion_5.png)\
*Gap-filling exercise*

![Single-choice question](general/res/ui_examples/neue_lektion_2.png)\
*Single-choice question*

![Open-ended question](general/res/ui_examples/neue_lektion_6.png)\
*Open-ended question*

![Widget of a listening exercise 1](general/res/ui_examples/neue_lektion_listening_1.png)\
*Widget of a listening exercise 1*

![Widget of a listening exercise 2](general/res/ui_examples/neue_lektion_listening_2.png)\
*Widget of a listening exercise 2*
...
![Example of a question on the grammar](general/res/ui_examples/question_1.png)\
*Example of a question on the grammar*

![Example of phrase help](general/res/ui_examples/question_2.png)\
*Example of phrase help*
...
![Legal questions](general/res/ui_examples/law_questions.png)\
*Legal questions*

![Anti-discrimination questions](general/res/ui_examples/antidisc_questions.png)\
*Anti-discrimination questions*
...
![Start message](general/res/ui_examples/law_start.png)\
*Introductory message*

...
class SettingsScreen extends StatelessWidget {
  ...
  Widget _buildSettingList(BuildContext context, double padding) {
    return Column(
      ...
      children: [_buildLanguageSelector(context, padding)],
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<LanguageBloc, LanguageState>(
      builder: (context, state) =>
          _buildDropdownButton(context, state, padding, languageBloc),
    );
  }

  Widget _buildDropdownButton(BuildContext context, LanguageState state,
      double padding, LanguageBloc languageBloc) {
    return Container(
